local cfg = {
	...
	-- set to 0 if you DO NOT want any API comments be shown -- This setting only take effect in insert mode, it does not affect signature help in normal
	-- mode, 10 by default
...
require 'lsp_signature'.setup(cfg, 0) -- no need to specify bufnr if you don't use toggle_key
