...
local function transparent(c)
    	...
    	if c == 'gruvbox' then
    		...
    		vim.api.nvim_set_hl(0, "LspDiagnosticsSignWarning", {ctermfg=214, ctermbg="none", fg="#fabd2f", bg="none"})
    		vim.api.nvim_set_hl(0, "LspDiagnosticsDefaultWarning", {ctermfg=214, ctermbg="none", fg="#fabd2f", bg="none"})
    		...
    		vim.api.nvim_set_hl(0, "LspDiagnosticsSignInformation", {ctermfg=109, ctermbg="none", fg="#83a598", bg="none"})
    	end
end
